            ...
            <div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8" itemscope itemtype="http://schema.org/Service">
                <div class="row">
                    <div class="col-12"  data-aos="fade-down" data-aos-offset="200" data-aos-easing="ease-in-sine" data-aos-duration="600">
                        <img src="images/landing/1.jpg" alt="<?php echo "$LN[1]";?>" class="img-fluid  img-thumbnail text-center"/>
                        <a href="services.php">
                            <div class="servicesHover">
                                <span class="h2 text-uppercase text-white stroke1 d-none d-md-inline-block"><?php echo $LN[1];?></span> 
                                <span class="h4 text-uppercase text-white stroke1 d-inline-block d-md-none"><?php echo $LN[1];?></span> 
                            </div>
                        </a>
                    </div>
                </div>
                <h4 class="t-color3 pt-3"><?php echo $License.' - '.$Phrase[1]; ?></h4>
                <?php echo $LD[1];?>
            </div>
